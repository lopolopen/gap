...
func (p *Pub[T]) Publish(ctx context.Context, topic string, msg T, headers map[string]any) error {
...
func (p *EventPub) Publish(ctx context.Context, event Event, headers map[string]any) error {
